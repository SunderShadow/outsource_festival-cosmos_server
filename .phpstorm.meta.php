...
'mail.markdown.extensions','platform.domain','platform.prefix','platform.middleware.public','platform.middleware.private',
'platform.guard','platform.auth','platform.index','platform.profile','platform.resource.stylesheets',
'platform.resource.scripts','platform.vite','platform.template.header','platform.template.footer','platform.attachment.disk',
'platform.attachment.generator','platform.icons.bs','platform.notifications.enabled','platform.notifications.interval','platform.search',
'platform.turbo.cache','platform.turbo.prefetch','platform.turbo.refresh-method','platform.turbo.refresh-scroll','platform.fallback',
'platform.workspace','platform.prevents_abandonment','platform.provider','queue.default','queue.connections.sync.driver',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','scout.driver',
...
'scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','scout.typesense.import_action','ide-helper.filename','ide-helper.models_filename',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'platform.index','platform.search','platform.async','platform.async.listener',
'platform.systems.files.upload','platform.systems.files.media','platform.systems.files.sort','platform.systems.files.destroy','platform.systems.files.update',
'platform.systems.relation','platform.systems.sorting','platform.notifications','platform.api.notifications','platform.',
'platform.login','platform.login.auth','platform.login.lock','platform.','platform.switch.logout',
'platform.logout','platform.main','platform.news','platform.news.create','platform.news.edit',
'platform.restaurants','platform.restaurants.create','platform.restaurants.edit','platform.restaurants.meal','platform.restaurants.meal.create',
'platform.restaurants.meal.edit','platform.profile','platform.systems.users.edit','platform.systems.users.create','platform.systems.users',
...
'APP_PORT','CLIENT_BASE_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
